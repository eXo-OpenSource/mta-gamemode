...
local function renderInventar()
		...
		dxDrawImage(x+20,y-48,48.0,48.0,"images/items.png",0.0,0.0,0.0,tocolor(255,255,255,255),false)
		...
		dxDrawImage(x+20 + 82,y-48,48.0,48.0,"images/items/Objekte.png",0.0,0.0,0.0,tocolor(255,255,255,255),false)
		...
		dxDrawImage(x+20 + 82*2,y-48,48.0,48.0,"images/food.png",0.0,0.0,0.0,tocolor(255,255,255,255),false)
		...
		dxDrawImage(x+20 + 82*3,y-48,48.0,48.0,"images/drogen.png",0.0,0.0,0.0,tocolor(255,255,255,255),false)
			...
			if item_table_aktuell then
				...
				if(id) then
					...
					if itemname then
						...
						if item_table then
							dxDrawImage(item[id]["x"],item[id]["y"],40,40,"images/items/"..icon,0.0,0.0,0.0,tocolor(rx,gx,bx,255),itemFront[id])
