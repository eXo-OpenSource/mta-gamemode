...
function()
{
	...
	$("#submit", stage1).click(function(){
		...
		var qry = $.get( "http://www.v-roleplay.net/forum/vrp/api.php?action=TS3SendActivation&nick="+nick,
		function(data)
		{	
			if(data != "1")
			{
	...
	$("#submit", stage2).click(function(){
		...
		var qry = $.get( "http://www.v-roleplay.net/forum/vrp/api.php?action=TS3CheckActivation&key="+key,
		function(data)
		{	
			alert(data);
			if(data != "1")
