ELS_PRESET = {
    ...
    ["DFT_Transporter"] = { 
        ...
        sequenceDuration = 100,
        light = {
			r1 = {0.9, 3.8, 1.5, 0.5, 255, 200, 0, 255},
			r2 = {-0.9, 3.8, 1.5, 0.5, 255, 200, 0, 255},
			r3 = {0.5, 3.8, 1.5, 0.5, 255, 200, 0, 255},
			r4 = {-0.5, 3.8, 1.5, 0.5, 255, 200, 0, 255},
			r5 = {-1, -4.8, -0.8, 0.5, 255, 200, 0, 255},
        },
        sequence = {
            [1] = {
                r1 = {blink = {0.05, 0.5, 350, 50}},
				r2 = {blink = {0.05, 0.5, 350, 50}},
				r3 = {blink = {0.05, 0.5, 350, 50}},
				r4 = {blink = {0.05, 0.5, 350, 50}},
				r5 = {blink = {0.1, 0.4, 250, 50}},
            }
        },
    },
}