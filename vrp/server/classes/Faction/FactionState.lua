	...
	if faction:isStateFaction() then
		if self:isPlayerInDutyPickup(client) or wasted then
			if client:isFactionDuty() then
				...
				client:getInventory():takeItem("taser", 1, true)
				client:getInventory():takeItem("warningCones", 1, true)
				client:getInventory():takeItem("barricade", 1, true)
				client:getInventory():takeItem("nailStrip", 1, true)
				client:getInventory():takeItem("speedCamera", 1, true)
				client:getInventory():takeItem("swathelmet", 1, true)
				...
				client:getInventory():takeItem("warningCones", 1, true)
				client:getInventory():giveItem("warningCones", 5)
				client:getInventory():takeItem("swathelmet", 1, true)
				client:getInventory():giveItem("swathelmet", 1)
				client:getInventory():takeItem("taser", 1, true)
