...
InteriorManager.InteriorData = {
    ...
    {enter = Vector3(-2336.95, -166.646, 34.3573), spawn = Vector3(363.11, -74.88, 1000.55), dimension = 3, interior = 10, rotation = 270},
    {enter = Vector3(-2356.48, 1008.01, 49.9036), spawn = Vector3(363.11, -74.88, 1000.55), dimension = 4, interior = 10, rotation = -180},
    {enter = Vector3(2366.74, 2071.02, 9.8218), spawn = Vector3(363.11, -74.88, 1000.55), dimension = 5, interior = 10, rotation = 90},
    {enter = Vector3(2472.68, 2033.88, 9.822), spawn = Vector3(363.11, -74.88, 1000.55), dimension = 6, interior = 10, rotation = 90},
    ...
    {enter = Vector3(2419.95, -1509.8, 23.1568), spawn = Vector3(365.67, -11.61, 1000.87), dimension = 3, interior = 9, rotation = 270},
    {enter = Vector3(2397.83, -1898.65, 12.7131), spawn = Vector3(365.67, -11.61, 1000.87), dimension = 4, interior = 9, rotation = 0},
    {enter = Vector3(928.525, -1352.77, 12.4344), spawn = Vector3(365.67, -11.61, 1000.87), dimension = 5, interior = 9, rotation = 90},
    {enter = Vector3(-1815.84, 618.678, 34.2989), spawn = Vector3(365.67, -11.61, 1000.87), dimension = 6, interior = 9, rotation = 208},
    {enter = Vector3(-2671.53, 258.344, 3.64932), spawn = Vector3(365.67, -11.61, 1000.87), dimension = 7, interior = 9, rotation = 5400.06},
    {enter = Vector3(2638.58, 1671.18, 10.0231), spawn = Vector3(365.67, -11.61, 1000.87), dimension = 8, interior = 9, rotation = 90},
    ...
    {enter = Vector3(1367.27, 248.388, 18.6229), spawn = Vector3(372.35, -133.55, 1000.45), dimension = 3, interior = 5, rotation = 69.0975},
    {enter = Vector3(203.334, -202.532, 0.600709), spawn = Vector3(372.35, -133.55, 1000.45), dimension = 4, interior = 5, rotation = -180},
    {enter = Vector3(2105.32, -1806.49, 12.6941), spawn = Vector3(372.35, -133.55, 1000.45), dimension = 5, interior = 5, rotation = 92},
    {enter = Vector3(-1808.69, 945.863, 23.8648), spawn = Vector3(372.35, -133.55, 1000.45), dimension = 6, interior = 5, rotation = 3824.59},
    {enter = Vector3(-1721.13, 1359.01, 6.19634), spawn = Vector3(372.35, -133.55, 1000.45), dimension = 7, interior = 5, rotation = 96},
    {enter = Vector3(2638.58, 1849.97, 10.0231), spawn = Vector3(372.35, -133.55, 1000.45), dimension = 8, interior = 5, rotation = 90},
    ...
    --{enter = Vector3(1833.54, -1843.38, 12.5595), spawn = Vector3(-30.95, -91.71, 1002.55), dimension = 0, interior = 18, rotation = 90}, -- 24/7
