...
function DeathmatchManager:constructor()
	...
	self.m_Blip = Blip:new("SniperGame.png", 1327.88, -1556.25)
	self.m_Blip:setDisplayText("Paintball-Arena", BLIP_CATEGORY.Leisure)
	self.m_Blip:setOptionalColor({244, 67, 54})
