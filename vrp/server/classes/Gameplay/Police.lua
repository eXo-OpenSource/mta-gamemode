...
function Police:constructor()
	...
	AutomaticVehicleSpawner:new(596, 1545.48, -1663.07, 5.61, 0.00, 0.00, 89.82,  policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(596, 1545.31, -1672.17, 5.61, 0.00, 0.00, 91.07,  policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(596, 1545.32, -1680.21, 5.61, 0.00, 0.00, 89.03,  policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(596, 1545.78, -1684.36, 5.61, 0.00, 0.00, 91.38,  policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(599, 1574.36, -1711.16, 6.08, 0.00, 0.00, 1.48,   policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(599, 1578.49, -1711.36, 6.08, 0.00, 0.00, 0.03,   policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(599, 1583.66, -1710.94, 6.08, 0.00, 0.00, 359.88, policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(601, 1564.39, -1710.41, 5.65, 0.00, 0.00, 0.57,   policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(528, 1595.60, -1710.79, 5.94, 0.00, 0.00, 359.42, policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(528, 1591.40, -1710.46, 5.94, 0.00, 0.00, 358.93, policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(596, 1601.44, -1704.34, 5.61, 0.00, 0.00, 89.49,  policeVehicleCreation, self)
	AutomaticVehicleSpawner:new(596, 1601.49, -1700.08, 5.61, 0.00, 0.00, 87.91,  policeVehicleCreation, self)
