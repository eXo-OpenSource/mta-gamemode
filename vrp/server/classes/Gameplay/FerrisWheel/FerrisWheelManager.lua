...
function FerrisWheelManager:constructor()
    ...
    FerrisWheelManager.Map[1] = FerrisWheel:new(Vector3(1479.35, -1665.9, 26.5), 0) -- christmas
    FerrisWheelManager.Map[2] = FerrisWheel:new(Vector3(391.100, -2028.580, 19.95), -90)
