...
function KeyBindings:constructor ()
  ...
  self.m_SelectedLabel = GUILabel:new(self.m_Width*0.4, self.m_Height*0.35, self.m_Width*0.32, self.m_Height*0.07, " ", self.m_Window):setVisible(false)
  self.m_SelectedButton = GUIButton:new(self.m_Width*0.4, self.m_Height*0.42, self.m_Width*0.32, self.m_Height*0.07, " ", self.m_Window):setBackgroundColor(Color.LightBlue):setFontSize(1.2):setVisible(false)
