...
-- *
-- *  PROJECT:     vRoleplay
-- *  FILE:        client/classes/GUIForms/GroupInviteGUI.lua
-- *  PURPOSE:     Group creation GUI class
-- *
-- ****************************************************************************
GroupInviteGUI = inherit(GUIForm)

function GroupInviteGUI:constructor()
...
function GroupInviteGUI:InviteButton_Click()
