...
-- *
-- ****************************************************************************
DrawTestGUI = inherit(GUIForm)
inherit(Singleton, DrawTestGUI)

function DrawTestGUI:constructor()
	GUIWindow.updateGrid()
	self.m_Width = grid("x", 21)
	self.m_Height = grid("y", 12)

	GUIForm.constructor(self, screenWidth/2-self.m_Width/2, screenHeight/2-self.m_Height/2, self.m_Width, self.m_Height, true)
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"DrawTestGUI", true, true, self)
	...
	self.m_ChangeColor.onLeftClick = bind(DrawTestGUI.changeColor, self)
...
function DrawTestGUI:virtual_destructor()

end


function DrawTestGUI:showInfoText(text)
...
function DrawTestGUI:hideInfoText()
...
function DrawTestGUI:changeColor()
	ColorPicker:new(
		function(r, g, b)
