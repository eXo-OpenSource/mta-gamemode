...
function GroupCreationGUI:constructor()
	GUIForm.constructor(self, screenWidth/2 - screenWidth*0.4/2, screenHeight/2 - screenHeight*0.20/2, screenWidth*0.4, screenHeight*0.20)
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"private Gang/Firma erstellen", true, true, self)
	GUILabel:new(self.m_Width*0.01, self.m_Height*0.18, self.m_Width*0.98, self.m_Height*0.14, _"Hier kannst du eine private Firma oder Gang gründen. Eine Gründung kostet 20.000$!", self.m_Window):setFont(VRPFont(self.m_Height*0.13))
