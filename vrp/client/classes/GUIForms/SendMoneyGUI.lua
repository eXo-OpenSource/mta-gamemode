...
function SendMoneyGUI:constructor(func, moneyAmount)
	...
	self.m_SendMoneyButton = VRPButton:new(self.m_Width*0.15, self.m_Height*0.64, self.m_Width*0.7, self.m_Height*0.27, _"Senden", true, self.m_Window):setBarColor(Color.Yellow)
