...
function BankGUI:constructor()
	...
	GUILabel:new(tabWidth*0.03, tabHeight*0.07, tabWidth*0.15, tabHeight*0.15, _"Empfänger:", self.m_TabTransfer)
	self.m_TransferToEdit = GUIEdit:new(tabWidth*0.2, tabHeight*0.07, tabWidth*0.5, tabHeight*0.15, self.m_TabTransfer)
	GUILabel:new(tabWidth*0.03, tabHeight*0.28, tabWidth*0.15, tabHeight*0.15, _"Betrag:", self.m_TabTransfer)
