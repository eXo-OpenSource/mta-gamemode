...
-- *
-- *  PROJECT:     vRoleplay
-- *  FILE:        client/classes/GUIForms/SuperSweeperLobbyManageGUI.lua
-- *  PURPOSE:     Super Sweeper Lobby Manage GUI
-- *
-- ****************************************************************************
SuperSweeperLobbyManageGUI = inherit(GUIForm)
inherit(Singleton, SuperSweeperLobbyManageGUI)

addRemoteEvents{"superSweeperReceiveCreateData"}


function SuperSweeperLobbyManageGUI:constructor()
...
function SuperSweeperLobbyManageGUI:destructor()
	GUIForm.destructor(self)
end

function SuperSweeperLobbyManageGUI:onShow()
	triggerServerEvent("superSweeperRequestCreateData", root)
end

function SuperSweeperLobbyManageGUI:onHide()
end

function SuperSweeperLobbyManageGUI:onChangeMode(mode)
...
function SuperSweeperLobbyManageGUI:updateSettingsGrid(mode)
	if self.m_ModeNames[mode] then
...
function SuperSweeperLobbyManageGUI:onSettingClick(name)
	setTimer(bind(self.handleOnSettingClick, self, name), 100, 1)
end

function SuperSweeperLobbyManageGUI:handleOnSettingClick(name)
...
function SuperSweeperLobbyManageGUI:onListEditSelect(name, values)
	self.m_SettingValues[name] = values
end

function SuperSweeperLobbyManageGUI:onSettingChangerSelect(name, items, index)
	for	key, value in pairs(self.m_ModeSettings[self.m_ModeChanger:getSelectedItem()]) do
...
function SuperSweeperLobbyManageGUI:onSettingBoolSelect(name, index)
	for	key, value in pairs(self.m_ModeSettings[self.m_ModeChanger:getSelectedItem()]) do
...
function SuperSweeperLobbyManageGUI:onSettingNumber(name, inputValue)
	for	key, value in pairs(self.m_ModeSettings[self.m_ModeChanger:getSelectedItem()]) do
...
function SuperSweeperLobbyManageGUI:createLobby()
...
function SuperSweeperLobbyManageGUI:receiveData(maps, modes)
