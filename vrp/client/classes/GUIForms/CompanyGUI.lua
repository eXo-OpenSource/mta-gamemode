...
--	self.m_CompanyQuitButton = GUIButton:new(self.m_Width*0.74, self.m_Height*0.02, self.m_Width*0.25, self.m_Height*0.07, _"Fraktion verlassen", tabAllgemein):setBackgroundColor(Color.Red)::setBarEnabled(true)
	...
	self.m_CompanyPlayerPermissionsButton = GUIButton:new(self.m_Width*0.64, self.m_Height*0.75, self.m_Width*0.3, self.m_Height*0.07, _"Rechteverwaltung", self.m_tabMitglieder):setBarEnabled(true)
...
function CompanyGUI:addLeaderTab()
	if self.m_LeaderTab == false then
		...
		self.m_ChangePermissions = GUIButton:new(self.m_Width*0.02, self.m_Height*0.66, self.m_Width*0.4, self.m_Height*0.07, _"Rechte bearbeiten", tabLeader):setBarEnabled(true)
