...
function HouseGUI:constructor(owner,price,rentprice,isValidRob)
	...
	self.m_Rent = GUIButton:new(30*4, 135, self.m_Width-(60*4), 35, _("Einmieten"), self)
	self.m_Rent:setBackgroundColor(Color.Green):setFont(VRPFont(28)):setFontSize(1)
	self.m_Rent.onLeftClick = bind(self.onRent,self)

	self.m_Unrent = GUIButton:new(30*4, 180, self.m_Width-(60*4), 35, _("Ausmieten"), self)
	...
	self.m_Buy = GUIButton:new(30*4, 225, self.m_Width-(60*4), 35, _("Haus kaufen"), self)
	self.m_Buy:setBackgroundColor(Color.Green):setFont(VRPFont(28)):setFontSize(1)
	self.m_Buy.onLeftClick = bind(self.buyHouse,self)

	self.m_Sell = GUIButton:new(30*4, 225, self.m_Width-(60*4), 35, _("Haus verkaufen"), self)
	...
	self.m_Enter = GUIButton:new(30*4, 280, self.m_Width-(60*4), 35, _("Betreten"), self)
	...
	self.m_Leave = GUIButton:new(30*4, 280, self.m_Width-(60*4), 35, _("Verlassen"), self)
