...
function GroupGUI:constructor()
	...
	self.m_GroupCreateLabel = GUILabel:new(self.m_Width*0.45, self.m_Height*0.14, self.m_Width*0.5, self.m_Height*0.06, _"Du kannst in der Stadthalle eine neue Firma oder Gang gründen!", tabGroups):seteMultiline(true)
	...
	self.m_VehicleRemoveFromGroup = VRPButton:new(self.m_Width*0.695, self.m_Height*0.34, self.m_Width*0.28, self.m_Height*0.07, _"Fahrzeug entfernen", true, tabVehicles):setBarColor(Color.Red)
