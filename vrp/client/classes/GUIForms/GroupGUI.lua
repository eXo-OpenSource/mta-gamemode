...
function GroupGUI:constructor()
	...
	self.m_GroupPlayerPermissionsButton = GUIButton:new(self.m_Width*0.64, self.m_Height*0.75, self.m_Width*0.3, self.m_Height*0.07, _"Rechteverwaltung", tabMitglieder):setBarEnabled(true)
