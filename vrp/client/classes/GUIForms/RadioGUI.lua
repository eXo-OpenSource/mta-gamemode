...
function RadioGUI:constructor()
	...
	self.m_Radioname = GUILabel:new(self.m_Width*0.06, self.m_Height*0.53, self.m_Width*0.88, self.m_Height*0.20, "", self.m_Background):setFont(VRPFont(self.m_Height*0.20))
