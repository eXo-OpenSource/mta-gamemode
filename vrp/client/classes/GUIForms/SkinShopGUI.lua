...
function SkinShopGUI:constructor()
	...
	self.m_SkinList = GUIGridList:new(0, self.m_Height/7, self.m_Width, self.m_Height-self.m_Height/7-self.m_Height/14, self.m_Window)
	self.m_SkinList:addColumn("", 0.57)
	self.m_SkinList:addColumn("", 0.4)
	self.m_ShopImage = GUIImage:new(0, 30, self.m_Width, self.m_Height/7, "files/images/ClothesHeader.png", self.m_Window)
