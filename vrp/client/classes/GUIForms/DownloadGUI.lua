...
function DownloadGUI:constructor()
	...
	self.m_Text = GUILabel:new(0, screenHeight/2 - 150/2 + 50, screenWidth, 50, "Bitte warten, bis alle Spieldateien geladen wurde...", self):setAlignX("center"):setFont(VRPFont(40))
