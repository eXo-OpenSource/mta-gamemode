...
function TradeGUI:constructor(myInventory)
    ...
    self.m_MyInventory = myInventory
    ...
    self.m_AmountEdit = GUIEdit:new(self.m_Width*0.09, self.m_Height*0.83, self.m_Width*0.14, self.m_Height*0.05, self.m_Window):setText("0"):setNumeric(true)
...
function TradeGUI:updateMyInventory(inv)
    ...
    -- TODO: Remove trade items from my inventory item list
