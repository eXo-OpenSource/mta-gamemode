...
function DrivingSchoolGUI:constructor()
	GUIForm.constructor(self, (screenWidth/2-screenWidth*0.15) / ASPECT_RATIO_MULTIPLIER, screenHeight*0.2, screenWidth*0.3 / ASPECT_RATIO_MULTIPLIER, screenHeight*0.4)
	self.m_Window = GUIWindow:new(0, 0, self.m_Width, self.m_Height, _"Flugschule", true, true, self)
	...
	self.m_BuyButton = GUIButton:new(self.m_Width*0.2, self.m_Height*0.88, self.m_Width*0.6, self.m_Height*0.09, _"Kaufen", self.m_Window)
