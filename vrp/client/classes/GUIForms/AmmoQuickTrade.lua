...
function AmmoQuickTradeGUI:constructor()
	...
	self.m_Label = GUIGridLabel:new(1, 1, 14, 2, "50%", self.m_Window):setAlign("center", "top")
...
function AmmoQuickTradeGUI:Event_onSliderChange()
	self.m_Label:setText(("%s%%"):format(math.ceil(self.m_AmmoAmount:getInternalRelativeValue()*100)))
end
