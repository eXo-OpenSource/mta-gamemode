...
function SelfGUI:constructor()
	...
	self.m_CompanyInvationLabel = GUILabel:new(self.m_Width*0.02, self.m_Height*0.85, self.m_Width*0.8, self.m_Height*0.06, "", tabGeneral)
	self.m_CompanyInvationLabel:setVisible(false)
	self.m_CompanyInvitationsAcceptButton = GUIButton:new(self.m_Width*0.8, self.m_Height*0.88, self.m_Width*0.08, self.m_Height*0.06, "✓", tabGeneral):setBackgroundColor(Color.Green)
	self.m_CompanyInvitationsAcceptButton:setVisible(false)
	self.m_CompanyInvitationsDeclineButton = GUIButton:new(self.m_Width*0.9, self.m_Height*0.88, self.m_Width*0.08, self.m_Height*0.06, "✕", tabGeneral):setBackgroundColor(Color.Red)
