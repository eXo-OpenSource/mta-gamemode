...
function SelfGUI:constructor()
	...
	self.m_LifeArmor = GUICheckbox:new(self.m_Width*0.5, self.m_Height*0.43, self.m_Width*0.35, self.m_Height*0.04, _"Leben/Weste am HUD", tabSettings)
...
function SelfGUI:Event_vehicleRetrieveInfo(vehiclesInfo, garageType, hangarType)
	...
	outputChatBox("Dein F2 Menü wurde aktualisiert!")
end
