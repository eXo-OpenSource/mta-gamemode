...
function JobHeliTransport:constructor()
	Job.constructor(self, 16, 1786.09, -2271.62, 26.80, 180, "HeliTransport.png", {120, 70, 0}, "files/images/Jobs/HeaderHeliTransport.png", _(HelpTextTitles.Jobs.HeliTransport):gsub("Job: ", ""), _(HelpTexts.Jobs.HeliTransport), LexiconPages.JobHeliTransport)
	self.m_Target = {}
