...
function JobForkLift:constructor()
	Job.constructor(self, 91.70, -221.12, 0.8, "ForkLift.png", "files/images/Jobs/HeaderForkLift.png", _(HelpTextTitles.Jobs.ForkLift):gsub("Job: ", ""), _(HelpTexts.Jobs.ForkLift))
