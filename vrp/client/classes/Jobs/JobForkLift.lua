...
function JobForkLift:constructor()
	Job.constructor(self, 16, 91.70, -221.12, 1.6, 0, "ForkLift.png", {255,143,0}, "files/images/Jobs/HeaderForkLift.png", _(HelpTextTitles.Jobs.ForkLift):gsub("Job: ", ""), _(HelpTexts.Jobs.ForkLift))
