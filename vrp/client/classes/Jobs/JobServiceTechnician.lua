...
function JobServiceTechnician:constructor()
    Job.constructor(self, 260, 900.80, -1447.34, 14.09, 0, "ServiceTechnician.png", "files/images/Jobs/HeaderServiceTechnician.png", _(HelpTextTitles.Jobs.ServiceTechnician):gsub("Job: ", ""), _(HelpTexts.Jobs.ServiceTechnician))
