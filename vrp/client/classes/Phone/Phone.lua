...
function Phone:constructor()
	...
	self:registerApp(PhoneApp.makeWebApp("Nachrichten",  "IconMessage.png", ("https://exo-reallife.de/ingame/vRPphone/apps/messages/index.php?player=%s&sessionID=%s"):format(localPlayer:getName(), localPlayer:getSessionId()), false, self))
