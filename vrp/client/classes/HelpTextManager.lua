...
function HelpTextManager:constructor()
	...
	self:addText("Freizeit", HelpTextTitles.Freizeit.Kart, HelpTexts.Freizeit.Kart)
	self:addText("Freizeit", HelpTextTitles.Freizeit.Angeln, HelpTexts.Freizeit.Angeln)
	self:addText("Freizeit", HelpTextTitles.Freizeit.Boxhalle, HelpTexts.Freizeit.Boxhalle)
	self:addText("Freizeit", HelpTextTitles.Freizeit.Bars, HelpTexts.Freizeit.Bars)
	self:addText("Freizeit", HelpTextTitles.Freizeit.Minispiele, HelpTexts.Freizeit.Minispiele)
	self:addText("Freizeit", HelpTextTitles.Freizeit.Pferderennen, HelpTexts.Freizeit.Pferderennen)
