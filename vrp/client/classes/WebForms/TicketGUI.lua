...
function TicketGUI:constructor()
	...
	self.m_WebView = GUIWebView:new(0, 30, self.m_Width, self.m_Height-30, ("https://cp.exo-reallife.de/api/auth/?redirect=/tickets?minimal&token=%s"):format(localPlayer:getSessionId()), true, self.m_Window)
