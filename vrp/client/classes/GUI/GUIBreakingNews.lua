...
function BreakingNews:constructor(text)
	...
	GUIImage:new(0, 0, self.m_Width-24, self.m_Height, "files/images/Other/BreakingNewsBG.png", self):setAlpha(190)
	GUIImage:new(self.m_Width-24, 0, 24, self.m_Height, "files/images/Other/BreakingNewsEnd.png", self):setAlpha(190)
