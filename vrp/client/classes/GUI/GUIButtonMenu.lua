...
function GUIButtonMenu:constructor(text, width, height, posX, posY)
	width = width and width or 300
	height = height and height or 380
	GUIForm.constructor(self, posX or screenWidth/2-(width/2), posY or screenHeight/2-(height/2), width, height)
