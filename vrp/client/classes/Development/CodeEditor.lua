...
function CodeEditorGUI:constructor()
	...
	self.m_NewBtn = GUIGridIconButton:new(17, 1, FontAwesomeSymbols.File, self.m_Window):setTooltip("Neue Klasse", "bottom")
	self.m_RefreshBtn = GUIGridIconButton:new(18, 1, FontAwesomeSymbols.Refresh, self.m_Window):setTooltip("Klasse (neu) laden", "bottom")
	self.m_CopyBtn = GUIGridIconButton:new(19, 1, FontAwesomeSymbols.Copy, self.m_Window):setTooltip("Code kopieren", "bottom")
	...
	self.m_NameEdit:setText("Klassenname")
