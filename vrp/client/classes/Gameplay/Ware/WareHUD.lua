...
function WareHUD:render_bomb() 
	...
	dxDrawImage((bombStartX+bombWidth + (screenWidth*0.3*(1-prog))) - ((screenWidth*0.015*scale - screenWidth*0.015)*0.5), bombStartY-((bombHeight*scale - bombHeight)*0.5), screenWidth*0.015*scale, bombHeight*scale, self:makePath("fire.png") , getTickCount(), -1*(screenWidth*0.015*scale)*0.1, 0, tocolor(255, 255, 255*prog, 255))
end
