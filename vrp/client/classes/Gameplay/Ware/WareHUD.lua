...
function WareHUD:render_bomb() 
	...
	dxDrawText(timeLeft, bombStartX, bombStartY+bombHeight*1.1, bombStartX + bombWidth, (bombStartY + bombHeight*1.1)+2, tocolor(0, 0, 0, 255), 2*scale, "default-bold", "center")
	dxDrawText(timeLeft, bombStartX, bombStartY+bombHeight*1.1, bombStartX + bombWidth, (bombStartY + bombHeight*1.1), tocolor(200, 200*(1-prog), 0, 255), 2*scale, "default-bold", "center")
