...
function Inventory:addItemEvents(item)
	...
	item.onLeftClick = function()
		if item.Item then
			...
			if not self.m_IsDeleteKeyDown then
				if localPlayer:getData("isTied") or localPlayer:getPublicSync("cuffed") then return ErrorBox:new(_"Du kannst derzeit nichts benutzen.") end
				...
				if localPlayer:getData("isTied") or localPlayer:getPublicSync("cuffed") then return ErrorBox:new(_"Du kannst derzeit nichts wegwerfen.") end
