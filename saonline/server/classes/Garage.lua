...
function Garage:constructor(px, py, pz, rx, ry, rz)
	...
	assert((type(pz) == 'number'), 'Bad argument @ \'Garage.constructor\' [Expected table at argument 3, got '..type(pz)..']')
	assert((type(rx) == 'number'), 'Bad argument @ \'Garage.constructor\' [Expected table at argument 4, got '..type(rx)..']')
	assert((type(ry) == 'number'), 'Bad argument @ \'Garage.constructor\' [Expected table at argument 5, got '..type(ry)..']')
	assert((type(rz) == 'number'), 'Bad argument @ \'Garage.constructor\' [Expected table at argument 6, got '..type(rz)..']')
