...
function CharacterSelectionGUI:constructor(accountinfo, charinfo)
	...
	for i = 1, MAX_CHARACTERS do
		...
		local lbl = GUILabel:new(0, 0, tabw-5, tabh*0.05, accountinfo.Username, 1, titlebar)
		lbl:setFont(smallfont)
		lbl:setAlignX("center")
		lbl:setAlignY("center")
		
		local wsize = tabh*0.2
		...
		GUILabel:new(10, tabh*0.31, tabw-25, 100, "Driving", 1, cc.info):setFont(smallfont)
		GUIBar:new(15, tabh*0.36, tabw-30, tabh*0.025, cfore, cback, 0.5, cc.info)

		GUILabel:new(10, tabh*0.40, tabw-25, 100, "Shooting", 1, cc.info):setFont(smallfont)
		GUIBar:new(15, tabh*0.45, tabw-30, tabh*0.025, cfore, cback, 0.5, cc.info)

		GUILabel:new(10, tabh*0.49, tabw-25, 100, "Flying", 1, cc.info):setFont(smallfont)
		GUIBar:new(15, tabh*0.54, tabw-30, tabh*0.025, cfore, cback, 0.5, cc.info)

		GUILabel:new(10, tabh*0.58, tabw-25, 100, "Sneaking", 1, cc.info):setFont(smallfont)
		GUIBar:new(15, tabh*0.63, tabw-30, tabh*0.025, cfore, cback, 0.5, cc.info)

		GUILabel:new(10, tabh*0.67, tabw-25, 100, "Endurance", 1, cc.info):setFont(smallfont)
		GUIBar:new(15, tabh*0.72, tabw-30, tabh*0.025, cfore, cback, 0.5, cc.info)
		
		GUILabel:new(10, tabh*0.80, tabw-25, 100, "Device Access", 1, cc.info):setFont(smallfont)
